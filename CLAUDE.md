...
- Only the stage marked "approved" in the design doc's *Immediate scope*
...
- Prototype 0's code is throwaway by design (see the design doc's
  *Technology strategy*): only the data model, snapping math, and anchor
  logic carry forward to the real engine, not the Panda3D code itself.
  Don't over-invest in polish here.

## Status

Current approved stage: **Prototype 0** (Panda3D spike). See the design
doc's *Roadmap* and *Immediate scope* sections for what's in and out.
